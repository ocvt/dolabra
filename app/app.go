...
func setRouters() {
  ...
  r.Route("/webtools", func(r chi.Router) {
    ...
    r.Get("/members", handler.GetWebtoolsMembers)
    r.Patch("/members/{memberId}/dues/grant", handler.PatchWebtoolsDuesGrant)
    r.Patch("/members/{memberId}/dues/revoke", handler.PatchWebtoolsDuesRevoke)
